...
Learning log adalah catatan resmi seluruh pembelajaran, pengalaman, best practice, dan hasil evaluasi yang diperoleh selama proses pengembangan AI Agent, Skill Claude, dokumentasi, maupun repository.

Apabila correction log menjawab pertanyaan *"apa yang salah dan bagaimana diperbaiki?"*, maka learning log menjawab pertanyaan *"apa yang kita pelajari dan bagaimana agar tidak terulang?"*.
...
4. **Menjadi materi onboarding yang hidup.** Anggota baru dan mahasiswa magang memperoleh konteks pengembangan tanpa harus menelusuri seluruh riwayat perubahan.
...
- [ ] Terdapat umpan balik pengguna internal yang mengungkap asumsi keliru pada perancangan agent.
...
| **Business Excellence Center (BEC)** | Memberikan klarifikasi substansi proses bisnis apabila pembelajaran menyentuh isi dokumen resmi, dan menilai kelayakan pembelajaran untuk diangkat menjadi standar yang lebih luas. |
| **Mahasiswa magang** | Boleh menjadi kontributor dan sangat dianjurkan mencatat hambatan yang dialami selama onboarding, karena hambatan tersebut merupakan indikator kelemahan dokumentasi. |
...
Sebuah judul pembelajaran dianggap layak apabila memenuhi seluruh butir berikut.
...
| "Bug skrip validasi" | "Seluruh variabel path pada skrip shell harus diapit tanda kutip" |
...
- [ ] Terdapat sekurang-kurangnya tiga bukti terdokumentasi
- [ ] Sekurang-kurangnya satu bukti berasal dari konteks berbeda dari kasus asal
...
- [ ] Telah berstatus `V3` sekurang-kurangnya satu siklus reviu bulanan
- [ ] Telah diwujudkan pada template, checklist, atau pemeriksaan otomatis
- [ ] Telah disosialisasikan kepada seluruh anggota tim
- [ ] Disetujui oleh Repository Maintainer
- [ ] Apabila menyentuh substansi proses bisnis, telah dikonfirmasi kepada BEC
...
flowchart TD
    ...
    G -- Tidak --> H{Terdapat 3 kasus<br/>dengan penyebab serupa?}
    H -- Ya --> J
...
3. **Uji dengan pertanyaan pembalikan.** Apabila kebalikan dari pernyataan pelajaran terdengar jelas keliru bagi siapa pun, maka pernyataan tersebut terlalu sepele untuk dicatat.
...
Sebuah koreksi layak diangkat menjadi lesson learned apabila memenuhi sekurang-kurangnya tiga dari lima butir berikut.
...
3. **Sertakan angka apabila tersedia.** "Tingkat pemanggilan skill yang tepat naik dari 62 persen menjadi 94 persen" jauh lebih kuat daripada "hasilnya membaik".
...
| Menetapkan `V4 — Standar` hanya berdasar satu kasus | Standar yang rapuh akan dibantah dan merusak kepercayaan | Kumpulkan bukti dari sekurang-kurangnya tiga kasus berbeda |
...
Contoh berikut merupakan ilustrasi berdasarkan situasi umum pengembangan repository AI Multi-Agent. Contoh ini bersifat **ilustratif** dan bukan catatan kejadian resmi.
...
| LL-SAF-202607-006 | 2026-07-20 | Contoh keluaran pada dokumentasi harus menggunakan data buatan, tidak boleh menggunakan cuplikan nyata | Dokumentasi internal banyak memuat contoh keluaran agent untuk memperjelas penjelasan | Beberapa contoh diambil langsung dari sesi nyata dan memuat penggalan isi dokumen internal | Seluruh contoh diganti dengan data buatan yang menyerupai, disertai penandaan eksplisit bahwa contoh bersifat ilustratif | Dokumentasi cenderung tersebar lebih luas daripada perkiraan penulisnya. Perlakukan setiap contoh dalam dokumentasi sebagai berpotensi terbaca pihak luar | Seluruh contoh pada tiga dokumen utama telah bersih dari cuplikan nyata | V2 | Repo Maintainer-DL |
...
Learning log hanya bernilai apabila dibaca sebelum keputusan diambil, bukan sekadar diisi setelah pekerjaan selesai. Repository Maintainer dianjurkan membuka learning log pada awal setiap perencanaan perubahan besar, dan mahasiswa magang dianjurkan membaca seluruh entri berstatus `V4` pada pekan pertama masa magangnya.

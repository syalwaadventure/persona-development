---
name: book-writer
description: >- Membuat dan merevisi buku, handbook, manual, modul, dan dokumentasi dalam HTML. Gunakan saat pengguna meminta penulisan, audit,pengembangan, atau penerbitan buku.
metadata:
  version: "0.2.0"
  status: "draft"
---
...
Skill ini **netral topik**. Tidak terikat pada organisasi, perusahaan, atau bidang tertentu — seluruh konteks berasal dari permintaan dan dokumen pengguna.
...
Tentukan mode di awal dan sebutkan pada baris pertama respons.
...
Perpindahan mode dinyatakan eksplisit. Mode Revise, Expand, dan Condense mengikuti `references/revision-guide.md`.
...
Untuk HTML: **mulai dari `assets/dark-book-template.html`.** Baca file itu sebelum menulis keluaran. Template sudah memuat seluruh CSS, JavaScript, kelas komponen, dua mode cetak, dan print stylesheet A4.
...
Pengguna boleh merevisi satu bab **tanpa membuat ulang seluruh buku**.
...
- **persona atau spesifikasi perilaku AI agent** → skill `persona`;

...
## 9. Mode K and CNBC International tests — v1.0 addition

Required test families:

1. Hard four-sector boundary.
2. Bilingual local/international search.
3. CNBC Indonesia Tier 2 behavior.
4. CNBC International Tier 2B behavior.
5. Global-to-Indonesia/Rekind transmission path.
6. Exclusion of generic global news.
7. Local/global duplicate synthesis.
8. Source access limitation.
9. Quiet-day no-filler behavior.
10. Standalone HTML and required sections.
11. Rekind relevance label with explicit mechanism.
12. No composite magic score.

Automatic failure conditions:

- item outside four sectors enters Mode K without a direct link;
- CNBC or any media is treated as an official source;
- international item lacks transmission path;
- “opportunity for Rekind” is asserted without a mechanism;
- inaccessible article content is invented;
- report uses filler to force 6–8 minutes;
- HTML loads external CDN/library.
